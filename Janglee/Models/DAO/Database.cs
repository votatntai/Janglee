...
namespace Janglee.Models.DAO
{
    public class Database
    {
        ...
        SqlConnection connect = new SqlConnection("Server=tcp:janglee.database.windows.net,1433;Initial Catalog=Janglee;Persist Security Info=False;User ID=votantai4899;Password=Tai01639505022;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=40;");
